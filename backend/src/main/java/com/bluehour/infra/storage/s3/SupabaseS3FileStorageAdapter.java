package com.bluehour.infra.storage.s3;
...
public class SupabaseS3FileStorageAdapter implements FileStoragePort {
    ...
    public SupabaseS3FileStorageAdapter(
            @Value("${bluehour.storage.s3.endpoint}") String endpoint,
            @Value("${bluehour.storage.s3.region:ap-southeast-1}") String region,
            @Value("${bluehour.storage.s3.access-key-id}") String accessKeyId,
            @Value("${bluehour.storage.s3.secret-access-key}") String secretAccessKey,
            @Value("${bluehour.storage.s3.bucket}") String bucket
    ) {
        this.bucket = bucket;
