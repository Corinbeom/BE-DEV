package com.bluehour.api.auth;

import com.bluehour.api.member.dto.MemberResponse;
...
public class AuthController {
    ...
    public AuthController(MemberRepository memberRepository,
                          ...
                          @org.springframework.beans.factory.annotation.Value("${bluehour.cookie-domain:}") String cookieDomain) {
    ...
    public ApiResponse<Void> logout(HttpServletRequest request, HttpServletResponse response) {
        ...
        String base = "bluehour_token=; Max-Age=0; Path=/; HttpOnly; Secure; SameSite=None";
