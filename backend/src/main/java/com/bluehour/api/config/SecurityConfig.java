package com.bluehour.api.config;

import com.bluehour.common.RequestLoggingFilter;
import com.bluehour.infra.auth.DevWebOAuth2UserService;
import com.bluehour.infra.auth.DevWebOidcUserService;
import com.bluehour.infra.auth.JwtAuthenticationFilter;
import com.bluehour.infra.auth.JwtTokenProvider;
import com.bluehour.infra.auth.OAuth2LoginSuccessHandler;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtTokenProvider jwtTokenProvider,
                          ...
                          @Value("${bluehour.frontend-url}") String frontendUrl) {
