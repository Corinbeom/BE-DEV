...
import com.bluehour.api.speechinterview.dto.ChatRequest;
import com.bluehour.api.speechinterview.dto.ChatResponse;
...
class SpeechInterviewServiceTest {
    ...
    void chat_maxTurns_completesSession() {
        ...
        for (int i = 0; i < 8; i++) {
            var q = new com.bluehour.domain.speechinterview.model.SpeechInterviewQuestion(
                    i, "질문" + i, "내용" + i, null, null, null);
            session.addQuestion(q);
            q.attachAnswer(new com.bluehour.domain.speechinterview.model.SpeechInterviewAnswer("답변" + i));
        }
